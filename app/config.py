...
class Config:
    ...
    DATABASE_MAX_PARALLEL_WORKERS = (
        ...
        else (int(os.getenv("DATABASE_MAX_PARALLEL_WORKERS")) if os.getenv("DATABASE_MAX_PARALLEL_WORKERS") else None)
    )
    DATABASE_MAX_PARALLEL_WORKERS_REPLICA = (
        int(os.getenv("DATABASE_MAX_PARALLEL_WORKERS_REPLICA"))
        if os.getenv("DATABASE_MAX_PARALLEL_WORKERS_REPLICA")
        else None
    )
