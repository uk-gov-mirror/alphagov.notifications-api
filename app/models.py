...
class Organisation(db.Model):
    ...
    letter_branding: Mapped[list["LetterBranding"]] = relationship("LetterBranding")
...
class AnnualBilling(db.Model):
    ...
    service: Mapped[list[Service]] = relationship(backref=db.backref("annual_billing"))
...
class ServiceSmsSender(db.Model):
    ...
    inbound_number: Mapped[InboundNumber] = relationship(backref=db.backref("inbound_number", uselist=False))
    created_at = db.Column(db.DateTime, default=datetime.datetime.utcnow, nullable=False)
    updated_at = db.Column(db.DateTime, nullable=True, onupdate=datetime.datetime.utcnow)
...
class ServicePermission(db.Model):
    ...
    service_permission_types: Mapped[Service] = relationship(
